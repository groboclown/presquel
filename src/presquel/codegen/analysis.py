...
class SchemaAnalysis(object):
    ...
    def update_references(self, analysis_model: object):
...
class ColumnAnalysis(SchemaAnalysis):
    def __init__(self, column: Column, package: str,
                 ...
                 is_read_only: bool):
        """
        :type constraints_analysis: list[AbstractProcessedConstraint]
        """
...
class ColumnSetAnalysis(SchemaAnalysis):
    def __init__(self, schema_obj: Table or View, package: str,
                 columns_analysis: tuple,
                 top_analysis: TopAnalysis, is_read_only: bool):
        """
        :type columns_analysis: tuple[ColumnAnalysis]
        """
    ...
    @property
    def columns_analysis(self) -> tuple:
        """
        :rtype: tuple[ColumnAnalysis]
        """
    ...
    def get_selectable_column_lists(self) -> list:
        """
    ...
    @property
    def top_write_validations(self) -> list:
        """
    ...
    @property
    def columns_for_create(self) -> list:
        """
    ...
    @property
    def columns_for_update(self) -> list:
        """
...
class AnalysisModel(object):
    ...
    def get_schemas_referencing(self, schema: str or SchemaObject) -> list:
        ...
        :rtype: list[(SchemaObject, ProcessedForeignKeyConstraint)]
        """
        if isinstance(schema, str):
            schema = self.get_schema_named(schema)
        assert isinstance(schema, SchemaObject)
    ...
    def _create_column_set_analysis(schema: SchemaObject, package: str,
        ...
        """
        :type column_analysis: list[ColumnAnalysis]
        """
